...
#ifndef INCLUDE__VT3_POU__SETUP_DATA_C
#define INCLUDE__VT3_POU__SETUP_DATA_C
...
static const vt3_screen_initializer FAR __init_table__setup_data[] = {
	{ NULL, NULL, 0 } /* sentinel */
}; /* __init_table__setup_data[] */

/* initialization of global data block */
void setup_data__init(void)
{
	const vt3_screen_initializer FARPTR p;

	/* initialize global data */
	for ( p = __init_table__setup_data; p->len; p ++ )
	{
...
#endif /* INCLUDE__VT3_POU__SETUP_DATA_C */
