...
#ifndef INCLUDE__VT3_POU__INIT_BYTEARRAY_P_H
#define INCLUDE__VT3_POU__INIT_BYTEARRAY_P_H
...
void INIT_BYTEARRAY_P__init(void);

/* prototype for the function that contains the POU body */
void INIT_BYTEARRAY_P__call(void);




#endif /* INCLUDE__VT3_POU__INIT_BYTEARRAY_P_H */
