...
#ifndef INCLUDE__VT3_POU__LCDSETBLANK_H
#define INCLUDE__VT3_POU__LCDSETBLANK_H
...
void lcdSetBlank__init(void);

/* prototype for the function that contains the POU body */
void lcdSetBlank__call(void);




#endif /* INCLUDE__VT3_POU__LCDSETBLANK_H */
