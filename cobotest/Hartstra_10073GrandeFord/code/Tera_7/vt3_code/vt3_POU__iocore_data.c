...
#ifndef INCLUDE__VT3_POU__IOCORE_DATA_C
#define INCLUDE__VT3_POU__IOCORE_DATA_C
...
static const vt3_screen_initializer FAR __init_table__iocore_data[] = {
	{ NULL, NULL, 0 } /* sentinel */
}; /* __init_table__iocore_data[] */

/* initialization of global data block */
void iocore_data__init(void)
{
	const vt3_screen_initializer FARPTR p;

	/* initialize global data */
	for ( p = __init_table__iocore_data; p->len; p ++ )
	{
...
#endif /* INCLUDE__VT3_POU__IOCORE_DATA_C */
